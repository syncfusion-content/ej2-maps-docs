...
| Enable grouping separator | **Property:** *enableGroupSeparator*<br/><br/> $("#container").ejMap({ <br/> &nbsp; enableGroupSeparator:true <br/> }); | **Property:** *useGroupingSeparator*<br/><br/> let maps: Maps = new Maps({ <br/> &nbsp; useGroupingSeparator: true <br/> }); <br/> maps.appendTo('#container') |
...
| Responsive | **Property:** *isResponsive*<br/><br/> $("#container").ejMap({ <br/> &nbsp; isResponsive:true <br/> }); | **Property:** *height* and *width*<br/><br/> let maps: Maps = new Maps({ <br/> &nbsp; height: '100px', width: '100px' <br/> }); <br/> maps.appendTo('#container') |
